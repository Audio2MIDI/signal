...
const ru = {
  ...
  "song-created": "Композиция создана",
  "song-saving": "Сохраняем…",
  "song-saved": "Сохранено",
  "download-midi": "Скачать MIDI",
  "untitled-song": "Без названия",
  name: "Название",
  rename: "Переименовать",
  track: "Дорожка",
  "add-track": "Добавить дорожку",
  "delete-track": "Удалить дорожку",
  "duplicate-track": "Дублировать дорожку",
  channel: "Канал",
  categories: "Категории",
  instruments: "Инструменты",
  "rhythm-track": "Ударные",
  "conductor-track": "Темп и размер",
  "track-name": "Название дорожки",
  cancel: "Отмена",
  ok: "ОК",
  reset: "Сбросить",
  "confirm-new": "Несохранённые изменения будут потеряны. Продолжить?",
  "confirm-open": "Несохранённые изменения будут потеряны. Продолжить?",
  "confirm-close": "Черновик ещё синхронизируется. Закрыть редактор?",
  help: "Справка",
  close: "Закрыть",
  ...
  "cut-selection": "Вырезать выделение",
  "paste-selection": "Вставить",
  "select-all": "Выделить все ноты",
  "select-next": "Следующая нота",
  "select-previous": "Предыдущая нота",
  ...
  arrange: "Дорожки",
  "arrangement-view": "Дорожки",
  "event-list": "Список событий",
  property: "Параметр",
  quantize: "Выровнять по сетке",
  "snap-to-grid": "Привязка к сетке",
  "export-audio": "Экспорт аудио",
  export: "Экспорт",
  "exporting-audio": "Экспортируем аудио…",
  "file-type": "Тип файла",
  ...
  "change-track-color": "Цвет дорожки",
  "control-settings": "Контроллеры",
  "show-note-labels": "Показывать названия нот",
  add: "Добавить",
  remove: "Удалить",
  "initialize-error": "Не удалось запустить редактор",
  "loading-external-midi": "Загружаем MIDI…",
  initializing: "Запускаем редактор…",
  soundfont: "SoundFont",
  midi: "MIDI",
  "no-files": "Нет файлов",
  velocity: "Velocity",
  ...
  key: "Тональность",
  scale: "Лад",
  "show-scale": "Показать лад",
  "hide-scale": "Скрыть лад",
